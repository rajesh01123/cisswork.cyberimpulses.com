...
$pds_contact_email = 'hello@progettidigital.com';
$pds_contact_phone = '+91 98765 43210';
?>
<!doctype html>
...
<head>
	...
	<style>
		...
		/* Contact hub: temporary company details can be replaced once final contact information is supplied. */
		.pds-utility--contact .pds-u-grid,.pds-utility--contact .pds-u-form-shell { display:none; }
		.pds-contact-hub { display:grid; grid-template-columns:1.15fr .85fr; gap:24px; margin:0 0 24px; }
		.pds-contact-spotlight,.pds-contact-location { position:relative; overflow:hidden; border-radius:24px; }
		.pds-contact-spotlight { min-height:344px; padding:45px; border:1px solid rgba(57,153,255,.72); background:radial-gradient(circle at 87% 18%,rgba(65,176,255,.46),transparent 23%),linear-gradient(122deg,#031229,#073372 63%,#0c62cf); box-shadow:0 24px 45px rgba(4,31,78,.25); color:#fff; }
		.pds-contact-spotlight::before { content:""; position:absolute; width:255px; height:255px; right:-105px; bottom:-132px; border:25px solid rgba(104,193,255,.2); border-radius:50%; }
		.pds-contact-spotlight::after { content:""; position:absolute; inset:0; opacity:.18; pointer-events:none; background-image:radial-gradient(circle,rgba(162,221,255,.92) 1px,transparent 1.6px); background-size:23px 23px; }
		.pds-contact-spotlight > *,.pds-contact-location > * { position:relative; z-index:1; }
		.pds-contact-kicker { margin:0 0 18px; color:#a9d8ff; font-size:12px; font-weight:850; letter-spacing:.13em; text-transform:uppercase; }
		.pds-contact-kicker::before { content:""; display:inline-block; width:9px; height:9px; margin:0 10px 1px 0; border-radius:50%; background:var(--pds-gold); box-shadow:0 0 0 6px rgba(255,184,46,.12); }
		.pds-contact-spotlight h2 { max-width:570px; margin:0 0 16px; color:#fff; font-size:clamp(34px,4vw,49px); line-height:1.08; letter-spacing:-.05em; }
		.pds-contact-spotlight h2 span { color:#62bdff; }
		.pds-contact-spotlight > p:not(.pds-contact-kicker) { max-width:560px; margin:0 0 26px; color:#d6e9ff; font-size:16px; line-height:1.7; }
		.pds-contact-location { display:flex; min-height:344px; flex-direction:column; align-items:flex-start; justify-content:center; padding:41px; border:1px solid rgba(64,155,255,.5); background:radial-gradient(circle at 89% 13%,rgba(255,184,46,.29),transparent 20%),linear-gradient(145deg,#fafdff,#e4f4ff); box-shadow:0 19px 38px rgba(19,66,124,.09); }
		.pds-contact-location::before { content:""; position:absolute; inset:0; opacity:.38; pointer-events:none; background-image:linear-gradient(rgba(20,110,232,.1) 1px,transparent 1px),linear-gradient(90deg,rgba(20,110,232,.1) 1px,transparent 1px); background-size:34px 34px; }
		.pds-contact-location-icon { display:grid; place-items:center; width:65px; height:65px; margin:0 0 25px; border-radius:19px; background:linear-gradient(145deg,#eaf6ff,#d5ebff); color:var(--pds-blue); box-shadow:0 11px 22px rgba(20,110,232,.13),inset 0 0 0 1px rgba(20,110,232,.08); font-size:29px; font-weight:900; }
		.pds-contact-location p { margin:0 0 11px; color:var(--pds-blue); font-size:12px; font-weight:850; letter-spacing:.12em; text-transform:uppercase; }
		.pds-contact-location h2 { margin:0 0 13px; color:var(--pds-ink); font-size:29px; line-height:1.13; letter-spacing:-.045em; }
		.pds-contact-location > span:not(.pds-contact-location-icon) { color:var(--pds-muted); font-size:15px; line-height:1.65; }
		.pds-contact-location small { display:inline-flex; align-items:center; gap:8px; margin-top:24px; color:#46627f; font-size:12px; font-weight:800; }
		.pds-contact-location small i { width:8px; height:8px; border-radius:50%; background:#1eb68c; box-shadow:0 0 0 5px rgba(30,182,140,.12); }
		.pds-contact-channels { display:grid; grid-template-columns:repeat(3,1fr); gap:18px; margin:0 0 24px; }
		.pds-contact-channel { display:flex; min-height:208px; flex-direction:column; gap:22px; padding:29px; border:1px solid rgba(111,169,232,.3); border-radius:20px; background:rgba(255,255,255,.88); box-shadow:0 14px 31px rgba(19,66,124,.07); color:inherit; text-decoration:none; transition:transform .25s ease,box-shadow .25s ease,border-color .25s ease; }
		.pds-contact-channel:hover { transform:translateY(-7px); border-color:rgba(20,110,232,.48); box-shadow:0 23px 41px rgba(19,66,124,.13); }
		.pds-contact-channel-icon { display:grid; place-items:center; width:50px; height:50px; border-radius:15px; background:#e6f3ff; color:var(--pds-blue); font-size:22px; font-weight:900; }
		.pds-contact-channel p { margin:0 0 8px; color:var(--pds-blue); font-size:12px; font-weight:850; letter-spacing:.1em; text-transform:uppercase; }
		.pds-contact-channel h2 { margin:0 0 10px; color:var(--pds-ink); font-size:20px; line-height:1.22; letter-spacing:-.035em; word-break:break-word; }
		.pds-contact-channel small { color:var(--pds-muted); font-size:13px; line-height:1.58; }
		.pds-contact-channel b { margin-top:auto; color:var(--pds-blue); font-size:22px; line-height:1; }
		.pds-contact-channel--pending { background:linear-gradient(145deg,rgba(255,255,255,.92),rgba(239,248,255,.85)); }
		.pds-contact-channel--pending .pds-contact-channel-icon { color:#5f87bd; }
		.pds-contact-social { display:flex; align-items:center; justify-content:space-between; gap:30px; padding:34px 39px; overflow:hidden; border:1px solid rgba(54,145,255,.7); border-radius:21px; background:radial-gradient(circle at 86% 14%,rgba(41,145,255,.44),transparent 23%),linear-gradient(120deg,#031127,#092f68); box-shadow:0 21px 40px rgba(5,33,81,.23); color:#fff; }
		.pds-contact-social p { margin:0 0 10px; color:#a9d8ff; font-size:12px; font-weight:850; letter-spacing:.12em; text-transform:uppercase; }
		.pds-contact-social h2 { margin:0 0 8px; color:#fff; font-size:30px; letter-spacing:-.045em; }
		.pds-contact-social > div > span { color:#cae3ff; font-size:14px; }
		.pds-contact-social-icons { display:flex; flex-wrap:wrap; gap:12px; justify-content:flex-end; }
		.pds-contact-social-icons a { display:grid; place-items:center; width:49px; height:49px; border:1px solid rgba(126,196,255,.34); border-radius:15px; background:rgba(20,110,232,.23); color:#fff; transition:transform .2s ease,background .2s ease,border-color .2s ease; }
		.pds-contact-social-icons a:hover { transform:translateY(-4px); border-color:#89d0ff; background:rgba(37,142,255,.48); }
		.pds-contact-social-icons svg { display:block; width:20px; height:20px; fill:currentColor; }
		.pds-u-motion .pds-contact-spotlight::before { animation:pds-u-contact-orbit 11s ease-in-out infinite; }
		.pds-u-motion .pds-contact-location-icon { animation:pds-u-contact-location 4.5s ease-in-out infinite; }
		@keyframes pds-u-contact-orbit { 0%,100% { transform:translate(0,0) rotate(0); } 50% { transform:translate(-18px,-12px) rotate(12deg); } }
		@keyframes pds-u-contact-location { 0%,100% { transform:translateY(0); } 50% { transform:translateY(-5px); } }
		@media (max-width:850px) { .pds-contact-hub { grid-template-columns:1fr; } .pds-contact-channels { grid-template-columns:repeat(2,1fr); } .pds-contact-channel:last-child { grid-column:1/-1; min-height:0; } }
		@media (max-width:560px) { .pds-contact-spotlight,.pds-contact-location { min-height:0; padding:31px 26px; } .pds-contact-spotlight h2 { font-size:36px; } .pds-contact-location h2 { font-size:27px; } .pds-contact-channels { grid-template-columns:1fr; } .pds-contact-channel,.pds-contact-channel:last-child { grid-column:auto; min-height:0; padding:26px; } .pds-contact-social { align-items:flex-start; flex-direction:column; padding:29px 26px; } .pds-contact-social h2 { font-size:27px; } .pds-contact-social-icons { justify-content:flex-start; } }
	</style>
</head>
	...
	<main>
		...
		<section class="pds-u-main"><div class="pds-wrap">
			...
			<?php elseif ( 'contact' === $pds_page ) : ?>
				...
				<div class="pds-contact-hub"><section class="pds-contact-spotlight pds-u-reveal"><p class="pds-contact-kicker">Progetti Digital Startup</p><h2>Let&rsquo;s shape your next <span>digital move.</span></h2><p>We are a product-minded software studio for teams ready to move an important idea forward. Start with a direct email and we will take it from there.</p><a class="pds-u-button" href="mailto:<?php echo esc_attr( $pds_contact_email ); ?>">Write to our team &rarr;</a></section><aside class="pds-contact-location pds-u-reveal"><span class="pds-contact-location-icon" aria-hidden="true">&#9678;</span><p>Studio location</p><h2>India &amp; remote worldwide</h2><span>Working with ambitious teams wherever the next product opportunity is.</span><small><i></i> Available by appointment</small></aside></div>
				<div class="pds-contact-channels"><a class="pds-contact-channel pds-u-reveal" href="mailto:<?php echo esc_attr( $pds_contact_email ); ?>"><span class="pds-contact-channel-icon" aria-hidden="true">@</span><div><p>Email the studio</p><h2><?php echo esc_html( $pds_contact_email ); ?></h2><small>For product, partnership, and project conversations.</small></div><b aria-hidden="true">&rarr;</b></a><a class="pds-contact-channel pds-u-reveal" href="tel:+919876543210"><span class="pds-contact-channel-icon" aria-hidden="true">&#9742;</span><div><p>Phone</p><h2><?php echo esc_html( $pds_contact_phone ); ?></h2><small>Temporary direct number for Progetti Digital Startup.</small></div><b aria-hidden="true">&rarr;</b></a><div class="pds-contact-channel pds-contact-channel--pending pds-u-reveal"><span class="pds-contact-channel-icon" aria-hidden="true">&#8982;</span><div><p>Location</p><h2>Address details coming soon</h2><small>Our office location will be added here.</small></div></div></div>
				<section class="pds-contact-social pds-u-reveal"><div><p>Follow Progetti Digital</p><h2>Keep an eye on what we build.</h2><span>Company-name profile links are ready to update when the final accounts are available.</span></div><div class="pds-contact-social-icons" aria-label="Progetti Digital Startup social profiles"><a href="https://www.linkedin.com/company/progetti-digital-startup/" target="_blank" rel="noopener noreferrer" aria-label="Progetti Digital Startup on LinkedIn"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5.1 3.5a2.1 2.1 0 1 1 0 4.2 2.1 2.1 0 0 1 0-4.2zM3.3 8.9h3.6V20H3.3V8.9zM9.1 8.9h3.4v1.5h.1c.5-.9 1.7-1.9 3.5-1.9 3.7 0 4.4 2.4 4.4 5.6V20h-3.6v-5.2c0-1.2 0-2.9-1.8-2.9s-2.1 1.4-2.1 2.8V20H9.1V8.9z"></path></svg></a><a href="https://www.instagram.com/progettidigitalstartup/" target="_blank" rel="noopener noreferrer" aria-label="Progetti Digital Startup on Instagram"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7.2 2h9.6A5.2 5.2 0 0 1 22 7.2v9.6a5.2 5.2 0 0 1-5.2 5.2H7.2A5.2 5.2 0 0 1 2 16.8V7.2A5.2 5.2 0 0 1 7.2 2zm0 2A3.2 3.2 0 0 0 4 7.2v9.6A3.2 3.2 0 0 0 7.2 20h9.6a3.2 3.2 0 0 0 3.2-3.2V7.2A3.2 3.2 0 0 0 16.8 4H7.2zm10.7 1.5a1.2 1.2 0 1 1 0 2.4 1.2 1.2 0 0 1 0-2.4zM12 6.8a5.2 5.2 0 1 1 0 10.4 5.2 5.2 0 0 1 0-10.4zm0 2a3.2 3.2 0 1 0 0 6.4 3.2 3.2 0 0 0 0-6.4z"></path></svg></a><a href="https://www.facebook.com/progettidigitalstartup/" target="_blank" rel="noopener noreferrer" aria-label="Progetti Digital Startup on Facebook"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13.6 21v-8h2.7l.4-3h-3.1V8.1c0-.9.3-1.5 1.6-1.5H17V3.9c-.3 0-1.3-.1-2.4-.1-2.4 0-4 1.4-4 4.1V10H8v3h2.6v8h3z"></path></svg></a><a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" aria-label="Progetti Digital Startup on WhatsApp"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a9.8 9.8 0 0 0-8.4 14.9L2.5 21l4.3-1.1A9.8 9.8 0 1 0 12 2zm0 17.8c-1.6 0-3.1-.4-4.4-1.2l-.3-.2-2.5.7.7-2.4-.2-.3A7.8 7.8 0 1 1 12 19.8zm4.3-5.8c-.2-.1-1.3-.6-1.5-.7-.2-.1-.4-.1-.5.1l-.7.8c-.1.1-.3.2-.5.1-1-.5-1.8-1.2-2.4-2.1-.1-.2 0-.4.1-.5l.4-.5.2-.4c.1-.1 0-.3 0-.4-.1-.1-.5-1.2-.7-1.6-.2-.4-.4-.3-.5-.3h-.5c-.2 0-.4.1-.6.3-.2.2-.8.8-.8 1.9s.8 2.2.9 2.4c.1.2 1.6 2.5 3.9 3.4.5.2 1 .4 1.3.5.6.2 1.1.2 1.5.1.5-.1 1.3-.5 1.5-1s.2-.9.2-1c-.1-.2-.3-.2-.5-.3z"></path></svg></a></div></section>
