	...
	<header class="pds-header">
		<div class="pds-shell pds-nav">
			...
			<nav class="pds-nav-links" aria-label="Primary navigation">
				<a href="#services">Services</a><a href="#process">Process</a><a href="#about">About</a><a href="#contact">Contact</a>
			</nav>
	...
	<main id="top">
		<section class="pds-hero">
			<div class="pds-shell pds-hero-grid">
				<div>
					...
					<h1>Software that turns bold ideas into real momentum.</h1>
				...
				<div class="pds-logo-card"><img src="<?php echo esc_url( $pds_logo_url ); ?>" alt="Progetti Digital Startup logo" width="1456" height="1088"><span class="pds-logo-caption">Imagine. Build. Grow.</span></div>
			</div>
		</section>

		<section class="pds-section pds-section--white" id="services">
			<div class="pds-shell">
				<div class="pds-section-heading"><p class="pds-eyebrow" style="color:#146ee8">What we do</p><h2>One product partner from first sketch to confident launch.</h2><p>We bring strategy, experience design, and engineering together so your product is useful, scalable, and ready for the next stage.</p></div>
				<div class="pds-service-grid">
					<article class="pds-service"><div class="pds-service-icon">⌘</div><h3>Custom Software</h3><p>Purpose-built platforms, internal tools, and SaaS products designed around the way your business actually works.</p></article>
					<article class="pds-service"><div class="pds-service-icon">◫</div><h3>Web Applications</h3><p>Fast, intuitive web experiences that help customers act, teams collaborate, and businesses scale online.</p></article>
					<article class="pds-service"><div class="pds-service-icon">⌁</div><h3>Mobile Products</h3><p>Focused mobile apps and cross-platform experiences that keep your service close to your customers.</p></article>
					<article class="pds-service"><div class="pds-service-icon">✦</div><h3>UI/UX Design</h3><p>Clear product journeys, useful interfaces, and flexible design systems built for people—not just screens.</p></article>
					<article class="pds-service"><div class="pds-service-icon">↗</div><h3>Cloud & Automation</h3><p>Connected workflows, integrations, and cloud-ready foundations that remove manual work and reduce friction.</p></article>
					<article class="pds-service"><div class="pds-service-icon">◎</div><h3>Product Support</h3><p>Iterative improvements, performance care, and a practical roadmap after launch to keep moving forward.</p></article>
				</div>
			</div>
		</section>
		...
		<section class="pds-section pds-band" id="about">
			<div class="pds-shell pds-band-grid">
				<div><p class="pds-eyebrow">Why Progetti Digital</p><h2>Startup speed. Engineering discipline.</h2><p>Great software starts with listening. We work alongside your team, make the hard decisions visible, and deliver in small, valuable steps.</p></div>
				<ul class="pds-list"><li>A focused team that speaks in outcomes, not buzzwords.</li><li>Transparent delivery from scope and architecture through launch.</li><li>Flexible engagement for a new idea, a product rebuild, or an ambitious next release.</li></ul>
			</div>
		</section>

		<section class="pds-section" id="process">
			<div class="pds-shell">
				<div class="pds-section-heading"><p class="pds-eyebrow" style="color:#146ee8">How we work</p><h2>A clear path from opportunity to working software.</h2></div>
				<div class="pds-process">
					<article class="pds-step"><div class="pds-step-number"></div><h3>Discover</h3><p>Understand your customers, goals, constraints, and the opportunity worth solving.</p></article>
					<article class="pds-step"><div class="pds-step-number"></div><h3>Define</h3><p>Shape the roadmap, user flows, and technical plan around the highest-value release.</p></article>
					<article class="pds-step"><div class="pds-step-number"></div><h3>Build</h3><p>Design, develop, test, and review in practical cycles with shared visibility.</p></article>
					<article class="pds-step"><div class="pds-step-number"></div><h3>Launch & Grow</h3><p>Release with confidence, learn from real use, and improve the product with purpose.</p></article>
				</div>
			</div>
		</section>

		<section class="pds-contact" id="contact">
			<div class="pds-shell pds-contact-grid"><div><h2>Have a product idea worth moving forward?</h2><p>Tell us where you are today. We’ll help you identify the next smart step.</p></div><a class="pds-button pds-button--light" href="#top">Start the conversation <span aria-hidden="true">↑</span></a></div>
		</section>
	</main>

	<footer class="pds-footer"><div class="pds-shell pds-footer-content"><span><strong>Progetti Digital Startup</strong> — software built for forward movement.</span><span>© <?php echo esc_html( gmdate( 'Y' ) ); ?> Progetti Digital Startup</span></div></footer>
</div>
<?php wp_footer(); ?>
</body>
</html>
